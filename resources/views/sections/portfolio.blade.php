            ...
            <div class="items ">
                ...
                <div class="work col-xs-4 web photography">
                    <div class="work-inner">
                        <div class="work-img">
                            <img src="{{ asset('assets/images/works/1.jpg') }}" alt=""/>
                            <div class="mask">
                ...
                <div class="work col-xs-4 photography design ">
                    <div class="work-inner">
                        <div class="work-img">
                            <img src="{{ asset('assets/images/works/2.jpg') }}" alt=""/>
                            <div class="mask">
                ...
                <div class="work col-xs-4 web photography design ">
                    <div class="work-inner">
                        <div class="work-img">
                            <img src="{{ asset('assets/images/works/3.jpg') }}" alt=""/>
                            <div class="mask">
                ...
                <div class="work col-xs-4 design web ">
                    <div class="work-inner">
                        <div class="work-img">
                            <img src="{{ asset('assets/images/works/4.jpg') }}" alt=""/>
                            <div class="mask">
                                <a class="button zoom" href="http://vimeo.com/55945051" data-rel="prettyPhoto[gallery]"><i class="fa fa-search"></i></a>
                                <a class="button detail"><i class="fa fa-film"></i></a>
                            </div>
                ...
                <div class="work col-xs-4 design photography ">
                    <div class="work-inner">
                        <div class="work-img">
                            <img src="{{ asset('assets/images/works/5.jpg') }}" alt=""/>
                            <div class="mask">
                ...
                <div class="work col-xs-4 web branding ">
                    <div class="work-inner">
                        <div class="work-img">
                            <img src="{{ asset('assets/images/works/6.jpg') }}" alt=""/>
                            <div class="mask">
