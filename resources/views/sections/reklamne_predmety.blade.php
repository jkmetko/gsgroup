<section id="why-wisten3" class="contain parallax">
    <div class="container">
        ...
        <div class="inner">
            ...
            <!-- Iphone images -->
            <div class="w-iphone animated text-center" data-animation="fadeInLeft" data-animation-delay="0">
                <img src="{{ asset('assets/images/reklamna_tabula.jpg') }}" alt="wisten-iphone" style="height: 400px; width: auto; margin: -50px 0 0 0">
            </div>

            <!-- accordion menu -->
            <div class="accordion" id="accordion6">

                <div class="accordion-head"><span class="colored-sepia">Reklamné</span> predmety</div>
